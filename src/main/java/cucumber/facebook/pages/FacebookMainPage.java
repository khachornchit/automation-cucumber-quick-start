...
public class FacebookMainPage extends BasePage {
	...
	public void moveMouseToSubMenuLogout() {
		int elementIndex = 12;
		action = new Actions(driver);
		WebElement element = driver.findElement(By.xpath(String.format(".//*[@class='_54nf']/li[%s]/a", elementIndex)));	
		action.moveToElement(element).build().perform();
	}
	
	public void clickSubMenuLogout() throws InterruptedException {
		action.click().build().perform();
		Thread.sleep(5000L);
	}
	
	public FacebookLoginPage returnToLoginPageAfterLogout() {
	...
	public void userNavigationMenuIsDisplayed() {
		wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("._54nf")));
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@class='_54nf']/li[12]/a")));		
	}

	public void moveMouseToSubMenuItemsOneByOne() {
		action = new Actions(driver);
		int index[] = { 1,3,4,6,7,9,10,11,12 };
		for (int i = 0; i < 9; i++) {
			WebElement element = driver.findElement(By.xpath(String.format(".//*[@class='_54nf']/li[%s]/a", index[i])));	
