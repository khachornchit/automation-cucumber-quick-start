...
public class FacebookLoginPage extends BasePage  {
	...
	public FacebookMainPage getLoginSuccessfullyPage() {
	...
	public void testLogoutRedirectPageSuccessfully() {
		Assert.assertTrue(buttonLogin.isDisplayed());
	}
	
	public FacebookSignUpPage returnFacebookSignUpPage() {
		return PageFactory.initElements(driver, FacebookSignUpPage.class);
	}
}